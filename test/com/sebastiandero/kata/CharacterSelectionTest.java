...
public class CharacterSelectionTest {
    ...
    public void shouldWorkWithNoMoves() {
        ...
        assertEquals(solution, CharacterSelection.superStreetFighterize(fighters, new int[] {0, 1}, new String[] {}));
    }
    ...
    public void shouldWorkWithFewMoves() {
        ...
        assertEquals(solution, CharacterSelection.superStreetFighterize(fighters, position, moves));
    }
    ...
    public void shouldRotateOnAllRows() {
        String[] moves = new String[] {"right",
                                       ...
                                       "right"};
        int[] position = new int[] {0, 2};
        String[] solution = new String[] {"Blanka",
                                          "Guile",
                                          "Ryu",
                                          "E.Honda",
                                          "Blanka",
    ...
    public void shouldRotateOnAllRows3() {
        String[] moves = new String[] {"right",
                                       ...
                                       "right"};
        int[] position = new int[] {0, 2};
        String[] solution = new String[] {"Cammy",
                                          "Blanka",
                                          "Guile",
                                          "Chun Li",
                                          "Ryu",
                                          ...
                                          "Deejay",
                                          "Cammy"};
        assertEquals(solution, CharacterSelection.superStreetFighterize(fighters3, position, moves));
    }

    @Test
    public void shouldJustWork3() {
        String[] moves = new String[] {"down",
                                       "right",
                                       "right",
                                       "right",
                                       "down",
    ...
    public void shouldWorkWithLongerGrid4() {
        ...
        String[] solution = new String[] {"E.Honda",
                                          ...
                                          "Deejay",
                                          "T.Hawk"};
        assertEquals(solution, CharacterSelection.superStreetFighterize(fighters4, position, moves));
    }
